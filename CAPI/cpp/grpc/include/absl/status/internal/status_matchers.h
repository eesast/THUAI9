...
namespace absl_testing
{
    ...
    namespace status_internal
    {
        ...
        public:
            ...
            /*implicit*/ StatusCode(::absl::StatusCode code) :
                code_(code)
            {
            }  // NOLINT
        ...
        public:
            ...
            {
                return common_impl_.MatchAndExplain(GetStatus(actual_value), result_listener);
            }
        ...
        public:
            ...
            StatusIsMatcher(StatusCodeMatcher&& code_matcher, StatusMessageMatcher&& message_matcher) :
                common_impl_(::testing::MatcherCast<StatusCode>(std::forward<StatusCodeMatcher>(code_matcher)), ::testing::MatcherCast<absl::string_view>(std::forward<StatusMessageMatcher>(message_matcher)))
            {
            }
            ...
            // either of them.
            template<typename T>
            /*implicit*/ operator ::testing::Matcher<T>() const
            {  // NOLINT
