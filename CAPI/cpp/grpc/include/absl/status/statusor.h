...
namespace absl
{
    ...
    public:
        ...
        template<typename U, absl::enable_if_t<internal_statusor::IsConstructionFromStatusOrValid<false, T, U, false, const U&>::value,
                                               int> = 0>
        ...
        template<typename U, absl::enable_if_t<internal_statusor::IsConstructionFromStatusOrValid<false, T, U, true, const U&>::value,
                                               int> = 0>
        ...
        template<typename U, absl::enable_if_t<internal_statusor::IsConstructionFromStatusOrValid<false, T, U, false, U&&>::value,
                                               int> = 0>
        ...
        template<typename U, absl::enable_if_t<internal_statusor::IsConstructionFromStatusOrValid<false, T, U, true, U&&>::value,
                                               int> = 0>
        ...
        template<typename U = T, absl::enable_if_t<internal_statusor::IsConstructionValid<false, T, U, false>::value,
                                                   int> = 0>
        StatusOr(U&& u)  // NOLINT
            :
        ...
        template<typename U = T, absl::enable_if_t<internal_statusor::IsConstructionValid<false, T, U, true>::value,
                                                   int> = 0>
        ...
        template<typename U = T, absl::enable_if_t<internal_statusor::IsConstructionValid<true, T, U, false>::value,
                                                   int> = 0>
        ...
        template<typename U = T, absl::enable_if_t<internal_statusor::IsConstructionValid<true, T, U, true>::value,
                                                   int> = 0>
    ...
    template<typename T, typename std::enable_if<absl::HasOstreamOperator<T>::value, int>::type = 0>
