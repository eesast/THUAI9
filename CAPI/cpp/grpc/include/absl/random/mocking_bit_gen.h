...
namespace absl
{
    ...
    private:
        ...
        template<typename MockFnType, typename ValidatorT, typename ResultT, typename Tuple>
        struct MockFnCaller;

        // specialization for std::tuple.
        template<typename MockFnType, typename ValidatorT, typename ResultT, typename... Args>
        ...
        template<typename MockFnType, typename ValidatorT, typename ResultT, typename ArgTupleT>
        ...
        template<typename ResultT, typename ArgTupleT, typename SelfT, typename ValidatorT>
            ...
            -> decltype(GetMockFnType(std::declval<ResultT>(), std::declval<ArgTupleT>()))&
        {
            ...
            using WrappedFnType = absl::conditional_t<
                ...
                absl::conditional_t<
                    ...
                    absl::conditional_t<
                        std::is_same<SelfT, ::testing::StrictMock<MockingBitGen>>::value,
