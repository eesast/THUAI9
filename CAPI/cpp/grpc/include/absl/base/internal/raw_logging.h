...
#define ABSL_RAW_LOG(severity, ...)                                                                                                \
    ...
    {                                                                                                                              \
        ...
        ::absl::raw_log_internal::RawLog(ABSL_RAW_LOG_INTERNAL_##severity, absl_raw_log_internal_basename, __LINE__, __VA_ARGS__); \
...
#define ABSL_INTERNAL_LOG(severity, message)                                                    \
    ...
    {                                                                                           \
        ...
        ::absl::raw_log_internal::internal_log_function(                                        \
            ABSL_RAW_LOG_INTERNAL_##severity, absl_raw_log_internal_filename, __LINE__, message \
        );                                                                                      \
        ABSL_RAW_LOG_INTERNAL_MAYBE_UNREACHABLE_##severity;                                     \
    } while (0)
