...
namespace absl
{
    ...
    public:
        ...
        public:
            ...
            explicit ChunkRange(absl::Nonnull<const Cord*> cord) :
                cord_(cord)
            {
            }
        ...
        public:
            ...
            explicit CharRange(absl::Nonnull<const Cord*> cord) :
                cord_(cord)
            {
            }
...
namespace absl
{
    ...
    Cord MakeCordFromExternal(absl::string_view data, Releaser&& releaser)
    {
        ...
        else
        {
            ...
            cord_internal::InvokeReleaser(
                cord_internal::Rank1{}, ReleaserType(std::forward<Releaser>(releaser)), data
            );
        }
        return cord;
    }

    constexpr Cord::InlineRep::InlineRep(absl::string_view sv, absl::Nullable<CordRep*> rep) :
        data_(sv, rep)
    {
    }
    ...
    constexpr Cord::Cord(strings_internal::StringConstant<T>) :
        contents_(strings_internal::StringConstant<T>::value, strings_internal::StringConstant<T>::value.size() <= cord_internal::kMaxInline ? nullptr : &cord_internal::ConstInitExternalStorage<strings_internal::StringConstant<T>>::value)
    {
    }
