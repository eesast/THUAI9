...
// work with NVCC either.
    ...
    !defined(__NVCC__)
    template<class T>
    struct is_trivially_relocatable : std::integral_constant<bool, std::is_trivially_copyable<T>::value || (__is_trivially_relocatable(T) && std::is_trivially_move_assignable<T>::value)>
    {
    };
#else
...
//
    ...
    namespace type_traits_internal
    {
        ...
        struct IsOwnerImpl<
            T,
            std::enable_if_t<std::is_class<typename T::absl_internal_is_view>::value>> : absl::negation<typename T::absl_internal_is_view>
        {
        };
        ...
        struct IsViewImpl<
            T,
            std::enable_if_t<std::is_class<typename T::absl_internal_is_view>::value>> : T::absl_internal_is_view
        {
        };
        ...
        template<typename T>
        struct IsView : std::integral_constant<bool, std::is_pointer<T>::value || IsViewImpl<T>::value>
        {
        };
