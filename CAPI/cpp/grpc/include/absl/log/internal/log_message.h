...
namespace absl
{
    ...
    namespace log_internal
    {
        ...
        public:
            ...
            // Used for `LOG`.
            LogMessage(absl::Nonnull<const char*> file, int line, absl::LogSeverity severity) ABSL_ATTRIBUTE_COLD;
            // These constructors are slightly smaller/faster to call; the severity is
            // curried into the function pointer.
            LogMessage(absl::Nonnull<const char*> file, int line, InfoTag) ABSL_ATTRIBUTE_COLD ABSL_ATTRIBUTE_NOINLINE;
            LogMessage(absl::Nonnull<const char*> file, int line, WarningTag) ABSL_ATTRIBUTE_COLD ABSL_ATTRIBUTE_NOINLINE;
            LogMessage(absl::Nonnull<const char*> file, int line, ErrorTag) ABSL_ATTRIBUTE_COLD ABSL_ATTRIBUTE_NOINLINE;
  ...
  LogMessage& operator<<(bool v) { return operator<< <bool>(v); }
            ...
            template<typename T, typename std::enable_if<absl::HasAbslStringify<T>::value, int>::type = 0>
        ...
        private:
            ...
            template<StringType str_type>
            void CopyToEncodedBufferWithStructuredProtoField(StructuredProtoField field, absl::string_view str)
        ...
        {
        public:
            explicit StringifySink(LogMessage& message) :
                message_(message)
            {
            }
            ...
            friend void AbslFormatFlush(absl::Nonnull<StringifySink*> sink, absl::string_view v)
            {
                sink->Append(v);
            }
        ...
        template<typename T, typename std::enable_if<absl::HasAbslStringify<T>::value, int>::type>
        ...
        extern template void
            LogMessage::CopyToEncodedBuffer<LogMessage::StringType::kLiteral>(char ch, size_t num);
        extern template void LogMessage::CopyToEncodedBuffer<
        ...
        {
        public:
            LogMessageFatal(absl::Nonnull<const char*> file, int line) ABSL_ATTRIBUTE_COLD;
            LogMessageFatal(absl::Nonnull<const char*> file, int line, absl::Nonnull<const char*> failure_msg) ABSL_ATTRIBUTE_COLD;
        ...
        {
        public:
            LogMessageDebugFatal(absl::Nonnull<const char*> file, int line) ABSL_ATTRIBUTE_COLD;
        ...
        public:
            ...
            LogMessageQuietlyDebugFatal(absl::Nonnull<const char*> file, int line) ABSL_ATTRIBUTE_COLD;
        ...
        {
        public:
            LogMessageQuietlyFatal(absl::Nonnull<const char*> file, int line) ABSL_ATTRIBUTE_COLD;
            LogMessageQuietlyFatal(absl::Nonnull<const char*> file, int line, absl::Nonnull<const char*> failure_msg)
                ABSL_ATTRIBUTE_COLD;
