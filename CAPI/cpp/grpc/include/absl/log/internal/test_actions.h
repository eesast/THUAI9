...
namespace absl
{
    ...
    namespace log_internal
    {
        ...
        {
            explicit WriteToStderr(absl::string_view m) :
                message(m)
            {
            }
            std::string message;
        ...
        {
            explicit WriteToStderrWithFilename(absl::string_view m) :
                message(m)
            {
            }
        ...
        {
            explicit WriteEntryToStderr(absl::string_view m) :
                message(m)
            {
            }
            ...
            void operator()(const absl::LogEntry& entry) const;
            void operator()(absl::LogSeverity, absl::string_view, absl::string_view) const;
        };
