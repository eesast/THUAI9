...
#define ABSL_LOG_INTERNAL_LOG_IF_EVERY_N_SEC_IMPL(severity, condition, n_seconds)    \
    ABSL_LOG_INTERNAL_CONDITION##severity(STATEFUL, condition)(EveryNSec, n_seconds) \
        ABSL_LOGGING_INTERNAL_LOG##severity.InternalStream()
...
#define ABSL_LOG_INTERNAL_PLOG_IF_EVERY_N_SEC_IMPL(severity, condition, n_seconds)   \
    ABSL_LOG_INTERNAL_CONDITION##severity(STATEFUL, condition)(EveryNSec, n_seconds) \
        ABSL_LOGGING_INTERNAL_LOG##severity.InternalStream()                         \
            .WithPerror()
...
#define ABSL_LOG_INTERNAL_DLOG_IF_EVERY_N_SEC_IMPL(severity, condition, n_seconds)   \
    ABSL_LOG_INTERNAL_CONDITION##severity(STATEFUL, condition)(EveryNSec, n_seconds) \
        ABSL_LOGGING_INTERNAL_DLOG##severity.InternalStream()
