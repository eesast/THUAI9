...
#define ABSL_LOG_INTERNAL_CHECK_OP(name, op, val1, val1_text, val2, val2_text) \
    ...
    ABSL_LOG_INTERNAL_CHECK(absl::implicit_cast<absl::Nonnull<const char*>>(   \
        ...
        .InternalStream()
#define ABSL_LOG_INTERNAL_QCHECK_OP(name, op, val1, val1_text, val2, val2_text) \
    ...
    ABSL_LOG_INTERNAL_QCHECK(absl::implicit_cast<absl::Nonnull<const char*>>(   \
        ...
        .InternalStream()
#define ABSL_LOG_INTERNAL_CHECK_STROP(func, op, expected, s1, s1_text, s2, s2_text)                \
    while (absl::Nullable<const char*> absl_log_internal_check_strop_result =                      \
               ::absl::log_internal::Check##func##expected##Impl(                                  \
                   (s1), (s2), ABSL_LOG_INTERNAL_STRIP_STRING_LITERAL(s1_text " " #op " " s2_text) \
               ))                                                                                  \
        ABSL_LOG_INTERNAL_CONDITION_FATAL(STATELESS, true)                                         \
    ABSL_LOG_INTERNAL_CHECK(absl::implicit_cast<absl::Nonnull<const char*>>(                       \
        ...
        .InternalStream()
#define ABSL_LOG_INTERNAL_QCHECK_STROP(func, op, expected, s1, s1_text, s2, s2_text)               \
...
#define ABSL_LOG_INTERNAL_CHECK_OK(val, val_text)                                                                                                                                                                                     \
    for (::std::pair<absl::Nonnull<const ::absl::Status*>, absl::Nullable<const char*>>                                                                                                                                               \
             absl_log_internal_check_ok_goo;                                                                                                                                                                                          \
         absl_log_internal_check_ok_goo.first =                                                                                                                                                                                       \
             ::absl::log_internal::AsStatus(val),                                                                                                                                                                                     \
         absl_log_internal_check_ok_goo.second =                                                                                                                                                                                      \
             ABSL_PREDICT_TRUE(absl_log_internal_check_ok_goo.first->ok()) ? nullptr : ::absl::status_internal::MakeCheckFailString(absl_log_internal_check_ok_goo.first, ABSL_LOG_INTERNAL_STRIP_STRING_LITERAL(val_text " is OK")), \
...
#define ABSL_LOG_INTERNAL_QCHECK_OK(val, val_text)                                                                                                                                                                                      \
    for (::std::pair<absl::Nonnull<const ::absl::Status*>, absl::Nullable<const char*>>                                                                                                                                                 \
         ...
         absl_log_internal_qcheck_ok_goo.second =                                                                                                                                                                                       \
             ABSL_PREDICT_TRUE(absl_log_internal_qcheck_ok_goo.first->ok()) ? nullptr : ::absl::status_internal::MakeCheckFailString(absl_log_internal_qcheck_ok_goo.first, ABSL_LOG_INTERNAL_STRIP_STRING_LITERAL(val_text " is OK")), \
...
namespace absl
{
    ...
    namespace log_internal
    {
        ...
        namespace detect_specialization
        {
            ...
            template<typename T>
            decltype(detect_specialization::operator<<(std::declval<std::ostream&>(), std::declval<const T&>()))
                Detect(char);
            ...
            public:
                ...
                friend std::ostream& operator<<(std::ostream& os, const StringifyToStreamWrapper& wrapper)
                {
...
#define ABSL_LOG_INTERNAL_CHECK_OP_IMPL(name, op)                                                                                \
    ...
    {                                                                                                                            \
        ...
        return ABSL_PREDICT_TRUE(v1 op v2) ? nullptr : ABSL_LOG_INTERNAL_CHECK_OP_IMPL_RESULT(U1, U2, U1(v1), U2(v2), exprtext); \
    }                                                                                                                            \
    inline constexpr absl::Nullable<const char*> name##Impl(                                                                     \
...
#undef ABSL_LOG_INTERNAL_CHECK_OP_IMPL
        ...
        absl::Nullable<const char*> CheckstrcmptrueImpl(
            absl::Nullable<const char*> s1, absl::Nullable<const char*> s2, absl::Nonnull<const char*> exprtext
        );
        ...
        inline constexpr char GetReferenceableValue(char t)
        {
            return t;
        }
        ...
        inline constexpr short GetReferenceableValue(short t)
        {
            return t;
        }
        ...
        inline constexpr int GetReferenceableValue(int t)
        {
            return t;
        }
        ...
        inline constexpr long GetReferenceableValue(long t)
        {
            return t;
        }
        ...
        inline constexpr long long GetReferenceableValue(long long t)
        {
            return t;
        }
