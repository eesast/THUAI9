...
namespace absl
{
    ...
    namespace log_internal
    {
        ...
        private:
            ...
            friend std::ostream& operator<<(std::ostream& os, const AsStructuredStringTypeImpl& impl)
            {
                return os << impl.str_;
            }
            ...
            friend LogMessage& operator<<(LogMessage& m, const AsStructuredStringTypeImpl& impl)
            {
                impl.AddToMessage(m);
                return m;
            }
        ...
        private:
            ...
            friend std::ostream& operator<<(std::ostream& os, const AsStructuredValueImpl& impl)
            {
            ...
            friend LogMessage& operator<<(LogMessage& m, const AsStructuredValueImpl& impl)
            {
                impl.AddToMessage(m);
                return m;
            }
        ...
        AsStructuredValueImpl(
            T value, StructuredProtoField field, typename AsStructuredValueImpl<T>::ValueFormatter value_formatter
        )
            -> AsStructuredValueImpl<T>;
