    ...
    namespace log_internal
    {
        ...
        public:
            ...
            bool IsEnabled(int level)
            {
                ...
                {
                    if (level == 0)
                        return SlowIsEnabled0(stale_v);
                    if (level == 1)
                        return SlowIsEnabled1(stale_v);
                    if (level == 2)
                        return SlowIsEnabled2(stale_v);
                    if (level == 3)
                        return SlowIsEnabled3(stale_v);
                    if (level == 4)
                        return SlowIsEnabled4(stale_v);
                    if (level == 5)
                        return SlowIsEnabled5(stale_v);
                }
#endif
        ...
        static_assert(std::is_trivially_destructible<VLogSite>::value, "VLogSite must be trivially destructible");
