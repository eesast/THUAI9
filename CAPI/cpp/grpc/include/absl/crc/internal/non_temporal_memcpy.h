...
namespace absl
{
    ...
    namespace crc_internal
    {
        ...
        // at compile time.
        inline void* non_temporal_store_memcpy(void* __restrict dst, const void* __restrict src, size_t len)
        {
...
// at compile time.
        ...
        [[gnu::target("avx")]]
#endif
        inline void* non_temporal_store_memcpy_avx(void* __restrict dst, const void* __restrict src, size_t len)
        {
