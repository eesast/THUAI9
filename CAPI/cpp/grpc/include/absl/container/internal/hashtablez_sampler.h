...
namespace absl
{
    ...
    namespace container_internal
    {
        ...
        struct HashtablezInfo : public profiling_internal::Sample<HashtablezInfo>
        {
            ...
            void PrepareForSampling(int64_t stride, size_t inline_element_size_value, size_t key_size, size_t value_size, uint16_t soo_capacity_value)
...
#error ABSL_INTERNAL_HASHTABLEZ_SAMPLE cannot be directly set
        ...
        public:
            ...
            {
                return ABSL_PREDICT_FALSE(info_ != nullptr);
            }
        ...
        )
        {
            ...
            return HashtablezInfoHandle(SampleSlow(global_next_sample, inline_element_size, key_size, value_size, soo_capacity));
#else
            return HashtablezInfoHandle(nullptr);
