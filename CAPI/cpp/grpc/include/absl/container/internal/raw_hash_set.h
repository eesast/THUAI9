...
#elif (defined(ABSL_HAVE_ADDRESS_SANITIZER) || defined(ABSL_HAVE_HWADDRESS_SANITIZER) || defined(ABSL_HAVE_MEMORY_SANITIZER)) && \
...
#define ABSL_SWISSTABLE_ASSERT(CONDITION) \
    assert((CONDITION) && "Try enabling sanitizers.")
        ...
        void SwapAlloc(AllocType& lhs, AllocType& rhs, std::false_type /* propagate_on_container_swap */)
        {
            (void)lhs;
            (void)rhs;
            assert(lhs == rhs && "It's UB to call swap with unequal non-propagating allocators.");
        }

        template<typename AllocType>
        void CopyAlloc(AllocType& lhs, AllocType& rhs, std::true_type /* propagate_alloc */)
        {
            lhs = rhs;
        }
        template<typename AllocType>
        ...
        ABSL_ATTRIBUTE_ALWAYS_INLINE inline bool ShouldInsertBackwards(
            ABSL_ATTRIBUTE_UNUSED size_t capacity, ABSL_ATTRIBUTE_UNUSED size_t hash, ABSL_ATTRIBUTE_UNUSED const ctrl_t* ctrl
        )
        {
#if defined(NDEBUG)
            return false;
        ...
        ABSL_ATTRIBUTE_ALWAYS_INLINE inline auto GetInsertionOffset(
            Mask mask, ABSL_ATTRIBUTE_UNUSED size_t capacity, ABSL_ATTRIBUTE_UNUSED size_t hash, ABSL_ATTRIBUTE_UNUSED const ctrl_t* ctrl
        )
        {
#if defined(NDEBUG)
            return mask.LowestBitSet();
#else
            return ShouldInsertBackwardsForDebug(capacity, hash, ctrl) ? mask.HighestBitSet() : mask.LowestBitSet();
#endif
        }
        ...
        struct GroupAArch64Impl
        {
            ...
            {
                uint64_t mask =
                    vget_lane_u64(vreinterpret_u64_u8(vceq_s8(vdup_n_s8(static_cast<int8_t>(ctrl_t::kEmpty)), vreinterpret_s8_u8(ctrl))), 0);
            ...
            auto MaskFull() const
            {
                uint64_t mask = vget_lane_u64(
                    vreinterpret_u64_u8(vcge_s8(vreinterpret_s8_u8(ctrl), vdup_n_s8(static_cast<int8_t>(0)))),
                    0
                );
                return BitMask<uint64_t, kWidth, /*Shift=*/3,
            ...
            {
                uint64_t mask = vget_lane_u64(
                    vreinterpret_u64_u8(vclt_s8(vreinterpret_s8_u8(ctrl), vdup_n_s8(static_cast<int8_t>(0)))),
                    0
                );
                return BitMask<uint64_t, kWidth, /*Shift=*/3,
                               /*NullifyBitsOnIteration=*/true>(mask);
            ...
            {
                uint64_t mask =
                    vget_lane_u64(vreinterpret_u64_u8(vcle_s8(vdup_n_s8(static_cast<int8_t>(ctrl_t::kSentinel)), vreinterpret_s8_u8(ctrl))), 0);
        ...
        struct GroupPortableImpl
        {
            ...
            NonIterableBitMask<uint64_t, kWidth, 3> MaskEmpty() const
            {
                return NonIterableBitMask<uint64_t, kWidth, 3>((ctrl & ~(ctrl << 6)) & kMsbs8Bytes);
            }
            ...
            NonIterableBitMask<uint64_t, kWidth, 3> MaskEmptyOrDeleted() const
            {
                return NonIterableBitMask<uint64_t, kWidth, 3>((ctrl & ~(ctrl << 7)) & kMsbs8Bytes);
            }
            ...
            uint32_t CountLeadingEmptyOrDeleted() const
            {
                ...
                return static_cast<uint32_t>(countr_zero((ctrl | ~(ctrl >> 7)) & bits) >> 3);
            }
        ...
        public:
            ...
            bool should_rehash_for_bug_detection_on_insert(const ctrl_t* ctrl, size_t capacity) const;
            // Similar to above, except that we don't depend on reserved_growth_.
            bool should_rehash_for_bug_detection_on_move(const ctrl_t* ctrl, size_t capacity) const;
            void maybe_increment_generation_on_insert()
            {
                if (reserved_growth_ == kReservedGrowthJustRanOut)
                    reserved_growth_ = 0;

                if (reserved_growth_ > 0)
                {
                    if (--reserved_growth_ == 0)
                        reserved_growth_ = kReservedGrowthJustRanOut;
                }
                else
                {
            ...
            size_t reserved_growth() const
            {
                return reserved_growth_;
            }
            ...
            GenerationType* generation_ptr() const
            {
                return generation_;
            }
        ...
        public:
            ...
            explicit HashSetIteratorGenerationInfoEnabled(
                ...
                generation_ptr_(generation_ptr),
                generation_(*generation_ptr)
            {
            }
            ...
            {
                generation_ = *generation_ptr_;
            }
            const GenerationType* generation_ptr() const
            {
                return generation_ptr_;
            }
            void set_generation_ptr(const GenerationType* ptr)
            {
                generation_ptr_ = ptr;
            }
        ...
        public:
            ...
            {
                ABSL_SWISSTABLE_ASSERT(GetGrowthLeft() >= static_cast<size_t>(IsEmpty(ctrl)));
        ...
        public:
            ...
            size_t generation_offset() const
            {
                return generation_offset_;
            }

            // Given the capacity of a table, computes the offset (from the start of the
            // backing allocation) at which the slots begin.
            size_t slot_offset() const
            {
                return slot_offset_;
            }
...
#define ABSL_SWISSTABLE_IGNORE_UNINITIALIZED_RETURN(x) return x
        ...
        union MaybeInitializedPtr
        {
            void* get() const
            {
                ABSL_SWISSTABLE_IGNORE_UNINITIALIZED_RETURN(p);
            }
            void set(void* ptr)
            {
                p = ptr;
        ...
        public:
            ...
            {
                return kSooEnabled ? CommonFields{soo_tag_t{}} : CommonFields{non_soo_tag_t{}};
            }

            // The inline data for SOO is written on top of control_/slots_.
            const void* soo_data() const
            {
                return heap_or_soo_.get_soo_data();
            }
            void* soo_data()
            {
                return heap_or_soo_.get_soo_data();
            ...
            HeapOrSoo heap_or_soo() const
            {
                return heap_or_soo_;
            }
            const HeapOrSoo& heap_or_soo_ref() const
            {
                return heap_or_soo_;
            }
            ...
            {
                return heap_or_soo_.slot_array().get();
            }
            ...
            void set_capacity(size_t c)
            {
                ...
                ABSL_SWISSTABLE_ASSERT(c == 0 || IsValidCapacity(c) || c > kAboveMaxValidCapacity);
                capacity_ = c;
            }
        ...
        private:
            ...
            static constexpr size_t HasInfozShift()
            {
                return 1;
            }
    ...
    ABSL_OPTION_HARDENED == 1 || !defined(NDEBUG)
        ...
        inline void AssertIsFull(const ctrl_t* ctrl, GenerationType generation, const GenerationType* generation_ptr, const char* operation)
        {
            ...
            {
                ABSL_RAW_LOG(FATAL, "%s called on default-constructed iterator.", operation);
            }
            if (SwisstableGenerationsEnabled())
            {
                if (ABSL_PREDICT_FALSE(generation != *generation_ptr))
                {
                    ABSL_RAW_LOG(FATAL, "%s called on invalid iterator. The table could have "
        ...
        inline void AssertIsValidForComparison(const ctrl_t* ctrl, GenerationType generation, const GenerationType* generation_ptr)
        {
            if (!SwisstableDebugEnabled())
                return;
            ...
            if (SwisstableGenerationsEnabled())
            {
                if (ABSL_PREDICT_FALSE(generation != *generation_ptr))
                {
                    ABSL_RAW_LOG(FATAL, "Invalid iterator comparison. The table could have rehashed "
        ...
        inline bool AreItersFromSameContainer(const ctrl_t* ctrl_a, const ctrl_t* ctrl_b, const void* const& slot_a, const void* const& slot_b)
        {
            // If either control byte is null, then we can't tell.
            if (ctrl_a == nullptr || ctrl_b == nullptr)
                return true;
            const bool a_is_soo = IsSooControl(ctrl_a);
            if (a_is_soo != IsSooControl(ctrl_b))
                return false;
            if (a_is_soo)
        ...
        // Note: we take slots by reference so that it's not UB if they're uninitialized
        // as long as we don't read them (when ctrl is null).
        inline void AssertSameContainer(const ctrl_t* ctrl_a, const ctrl_t* ctrl_b, const void* const& slot_a, const void* const& slot_b, const GenerationType* generation_ptr_a, const GenerationType* generation_ptr_b)
        {
            if (!SwisstableDebugEnabled())
                return;
            // `SwisstableDebugEnabled()` is also true for release builds with hardening
            ...
            if (a_is_default && b_is_default)
                return;
            fail_if(a_is_default != b_is_default, "Comparing default-constructed hashtable iterator with a "
                                                  "non-default-constructed hashtable iterator.");

            if (SwisstableGenerationsEnabled())
            {
                if (ABSL_PREDICT_TRUE(generation_ptr_a == generation_ptr_b))
                    return;
                // Users don't need to know whether the tables are SOO so don't mention SOO
                // in the debug message.
                const bool a_is_soo = IsSooControl(ctrl_a);
                const bool b_is_soo = IsSooControl(ctrl_b);
                fail_if(a_is_soo != b_is_soo || (a_is_soo && b_is_soo), "Comparing iterators from different hashtables.");

                const bool a_is_empty = IsEmptyGeneration(generation_ptr_a);
                const bool b_is_empty = IsEmptyGeneration(generation_ptr_b);
                fail_if(a_is_empty != b_is_empty, "Comparing an iterator from an empty hashtable with an iterator "
                                                  "from a non-empty hashtable.");
                fail_if(a_is_empty && b_is_empty, "Comparing iterators from different empty hashtables.");

                const bool a_is_end = ctrl_a == nullptr;
                const bool b_is_end = ctrl_b == nullptr;
                fail_if(a_is_end || b_is_end, "Comparing iterator with an end() iterator from a different "
                                              "hashtable.");
        ...
        inline void DoSanitizeOnSetCtrl(const CommonFields& c, size_t i, ctrl_t h, size_t slot_size)
        {
        ...
        inline void SetCtrl(const CommonFields& c, size_t i, ctrl_t h, size_t slot_size)
        {
            DoSanitizeOnSetCtrl(c, i, h, slot_size);
            ctrl_t* ctrl = c.control();
            ctrl[i] = h;
            ctrl[((i - NumClonedBytes()) & c.capacity()) + (NumClonedBytes() & c.capacity())] = h;
        }
        ...
        inline void SetCtrlInSingleGroupTable(const CommonFields& c, size_t i, ctrl_t h, size_t slot_size)
        {
        ...
        // Overload for setting to an occupied `h2_t` rather than a special `ctrl_t`.
        inline void SetCtrlInSingleGroupTable(const CommonFields& c, size_t i, h2_t h, size_t slot_size)
        {
        ...
        {
            return static_cast<void*>(static_cast<char*>(slot_array) + (slot * slot_size));
        }
        ...
        )
        {
            ...
            if (is_small(cap))
            {
                ...
                ABSL_SWISSTABLE_ASSERT(cap <= GroupPortableImpl::kWidth && "unexpectedly large small capacity");
                static_assert(Group::kWidth >= GroupPortableImpl::kWidth, "unexpected group width");
            ...
            while (remaining != 0)
            {
                ...
                {
                    ABSL_SWISSTABLE_ASSERT(IsFull(ctrl[i]) && "hash table was modified unexpectedly");
                    cb(ctrl + i, slot + i);
                    --remaining;
                }
                ctrl += Group::kWidth;
            ...
            ABSL_SWISSTABLE_ASSERT(original_size_for_assert >= c.size() && "hash table was modified unexpectedly");
        }
        ...
        template<bool kSooEnabled>
        HashtablezInfoHandle SampleHashtablezInfo(size_t sizeof_slot, size_t sizeof_key, size_t sizeof_value, size_t old_capacity, bool was_soo, HashtablezInfoHandle forced_infoz, CommonFields& c)
        {
            if (forced_infoz.IsSampled())
                return forced_infoz;
        ...
        {
        public:
            explicit HashSetResizeHelper(CommonFields& c, bool was_soo, bool had_soo_slot, HashtablezInfoHandle forced_infoz) :
            ...
            static FindInfo FindFirstNonFullAfterResize(const CommonFields& c, size_t old_capacity, size_t hash);

            HeapOrSoo& old_heap_or_soo()
            {
                return old_heap_or_soo_;
            }
            void* old_soo_data()
            {
                return old_heap_or_soo_.get_soo_data();
            }
            ...
            size_t old_capacity() const
            {
                return old_capacity_;
            }
            ...
            template<typename Alloc, size_t SizeOfSlot, bool TransferUsesMemcpy, bool SooEnabled, size_t AlignOfSlot>
            ABSL_ATTRIBUTE_NOINLINE bool InitializeSlots(CommonFields& c, Alloc alloc, ctrl_t soo_slot_h2, size_t key_size, size_t value_size)
            {
                ABSL_SWISSTABLE_ASSERT(c.capacity());
                HashtablezInfoHandle infoz =
                    ShouldSampleHashtablezInfo<Alloc>() ? SampleHashtablezInfo<SooEnabled>(SizeOfSlot, key_size, value_size, old_capacity_, was_soo_, forced_infoz_, c) : HashtablezInfoHandle{};
            ...
            void DeallocateOld(CharAlloc alloc_ref, size_t slot_size)
            {
                ...
                Deallocate<BackingArrayAlignment(AlignOfSlot)>(
                    &alloc_ref, old_ctrl() - layout.control_offset(), layout.alloc_size(slot_size)
                );
            }

        private:
            // Returns true if `GrowSizeIntoSingleGroup` can be used for resizing.
            static bool IsGrowingIntoSingleGroupApplicable(size_t old_capacity, size_t new_capacity)
            {
            ...
            void GrowIntoSingleGroupShuffleControlBytes(ctrl_t* new_ctrl, size_t new_capacity) const;
            ...
            void InitControlBytesAfterSoo(ctrl_t* new_ctrl, ctrl_t h2, size_t new_capacity);
            ...
            void GrowIntoSingleGroupShuffleTransferableSlots(void* new_slots, size_t slot_size) const;
            ...
            void PoisonSingleGroupEmptySlots(CommonFields& c, size_t slot_size) const
            {
                ...
                for (size_t i = 0; i < c.capacity(); ++i)
                {
                    ...
                    {
                        SanitizerPoisonMemoryRegion(SlotAddress(c.slot_array(), i, slot_size), slot_size);
                    }
                }
            }
        ...
        size_t PrepareInsertAfterSoo(size_t hash, size_t slot_size, CommonFields& common);
        ...
        struct PolicyFunctions
        {
            ...
            void (*resize)(CommonFields& common, size_t new_capacity, HashtablezInfoHandle forced_infoz);
        };

        // ClearBackingArray clears the backing array, either modifying it in place,
        // or creating a new one based on the value of "reuse".
        // REQUIRES: c.capacity > 0
        void ClearBackingArray(CommonFields& c, const PolicyFunctions& policy, bool reuse, bool soo_enabled);
        ...
        ABSL_ATTRIBUTE_NOINLINE void DeallocateStandard(CommonFields& common, const PolicyFunctions& policy)
        {
            // Unpoison before returning the memory to the allocator.
            SanitizerUnpoisonMemoryRegion(common.slot_array(), policy.slot_size * common.capacity());

            std::allocator<char> alloc;
            common.infoz().Unregister();
            Deallocate<BackingArrayAlignment(AlignOfSlot)>(
                &alloc, common.backing_array_start(), common.alloc_size(policy.slot_size, AlignOfSlot)
            );
        }
        ...
        size_t PrepareInsertNonSoo(CommonFields& common, size_t hash, FindInfo target, const PolicyFunctions& policy);
        ...
        private:
            ...
            bool is_soo() const
            {
                return fits_in_soo(capacity());
            }
            bool is_full_soo() const
            {
                return is_soo() && !empty();
            }
        ...
        public:
            ...
            public:
                ...
                friend bool operator==(const iterator& a, const iterator& b)
                {
                    ...
                    AssertSameContainer(a.ctrl_, b.ctrl_, a.slot_, b.slot_, a.generation_ptr(), b.generation_ptr());
            ...
            private:
                iterator(ctrl_t* ctrl, slot_type* slot, const GenerationType* generation_ptr) :
                ...
                iterator(ctrl_t* ctrl, MaybeInitializedPtr slot, const GenerationType* generation_ptr) :
                    HashSetIteratorGenerationInfo(generation_ptr),
                    ctrl_(ctrl),
                ...
                // checks.
                reference unchecked_deref() const
                {
            ...
            private:
                const_iterator(const ctrl_t* ctrl, const slot_type* slot, const GenerationType* gen) :
                    inner_(const_cast<ctrl_t*>(ctrl), const_cast<slot_type*>(slot), gen)
                {
                }
                ctrl_t* control() const
                {
                    return inner_.control();
                }
                slot_type* slot() const
                {
                    return inner_.slot();
            ...
            raw_hash_set(const raw_hash_set& that, const allocator_type& a) :
                raw_hash_set(GrowthToLowerboundCapacity(that.size()), that.hash_ref(), that.eq_ref(), a)
            {
                ...
                IterateOverFullSlots(
                    that.common(), that.slot_array(), [&](const ctrl_t* that_ctrl, slot_type* that_slot) ABSL_ATTRIBUTE_ALWAYS_INLINE
                    {
          if (shift == 0) {
          ...
          common().maybe_increment_generation_on_insert(); }
            ...
            ABSL_ATTRIBUTE_NOINLINE raw_hash_set(raw_hash_set&& that) noexcept(
                ...
                settings_(PolicyTraits::transfer_uses_memcpy() || !that.is_full_soo() ? std::move(that.common()) : CommonFields{full_soo_tag_t{}}, that.hash_ref(), that.eq_ref(), that.alloc_ref())
            {
            ...
            raw_hash_set(raw_hash_set&& that, const allocator_type& a) :
                settings_(CommonFields::CreateDefault<SooEnabled()>(), that.hash_ref(), that.eq_ref(), a)
            {
                if (a == that.alloc_ref())
                {
                    swap_common(that);
            ...
            {
                that.AssertNotDebugCapacity();
                if (ABSL_PREDICT_FALSE(this == &that))
                    return *this;
            ...
            iterator begin() ABSL_ATTRIBUTE_LIFETIME_BOUND
            {
                ...
                if (is_soo())
                    return soo_iterator();
                iterator it = {control(), common().slots_union(), common().generation_ptr()};
            ...
            ABSL_ATTRIBUTE_REINITIALIZES void clear()
            {
                ...
                {
                    destroy_slots();
                    ClearBackingArray(common(), GetPolicyFunctions(), /*reuse=*/cap < 128, SooEnabled());
                }
            ...
            template<class T, std::enable_if_t<IsDecomposableAndInsertable<T>::value && IsNotBitField<T>::value && !IsLifetimeBoundAssignmentFrom<T>::value, int> = 0>
            ...
            //   s.insert(p);
            //
            template<class T, std::enable_if_t<IsDecomposableAndInsertable<const T&>::value && !IsLifetimeBoundAssignmentFrom<const T&>::value, int> = 0>
            ...
            template<class T, std::enable_if_t<IsDecomposableAndInsertable<T>::value && IsNotBitField<T>::value && IsLifetimeBoundAssignmentFrom<T>::value, int> = 0>
            iterator insert(const_iterator, T&& value ABSL_INTERNAL_ATTRIBUTE_CAPTURED_BY(this)) ABSL_ATTRIBUTE_LIFETIME_BOUND
            {
                return insert(std::forward<T>(value)).first;
            }

            template<class T, std::enable_if_t<IsDecomposableAndInsertable<const T&>::value, int> = 0>
            iterator insert(const_iterator, const T& value) ABSL_ATTRIBUTE_LIFETIME_BOUND
            {
                return insert(value).first;
            }

            iterator insert(const_iterator, init_type&& value) ABSL_ATTRIBUTE_LIFETIME_BOUND
            {
            ...
            iterator insert(const_iterator, node_type&& node) ABSL_ATTRIBUTE_LIFETIME_BOUND
            {
            ...
            template<class... Args>
            iterator emplace_hint(const_iterator, Args&&... args) ABSL_ATTRIBUTE_LIFETIME_BOUND
            {
            ...
            iterator lazy_emplace(const key_arg<K>& key, F&& f) ABSL_ATTRIBUTE_LIFETIME_BOUND
            {
            ...
            iterator erase(const_iterator first, const_iterator last) ABSL_ATTRIBUTE_LIFETIME_BOUND
            {
                AssertNotDebugCapacity();
                ...
                if (first == begin() && last == end())
                {
                    ...
                    destroy_slots();
                    ClearBackingArray(common(), GetPolicyFunctions(), /*reuse=*/true, SooEnabled());
            ...
            {  // NOLINT
                ...
                {
                    return PolicyTraits::apply(InsertSlot<false>{*this, std::move(*src_slot)}, PolicyTraits::element(src_slot))
                        .second;
                };
                ...
                if (src.is_soo())
                {
                    if (src.empty())
                        return;
                    if (insert_slot(src.soo_slot()))
                        src.common().set_empty_soo();
                    return;
                }
                for (auto it = src.begin(), e = src.end(); it != e;)
                {
                    auto next = std::next(it);
                    if (insert_slot(it.slot()))
            ...
            {
                AssertNotDebugCapacity();
                AssertIsFull(position.control(), position.inner_.generation(), position.inner_.generation_ptr(), "extract()");
            ...
            void rehash(size_t n)
            {
                ...
                if (n == 0)
                {
                    ...
                    if (empty())
                    {
                        ClearBackingArray(common(), GetPolicyFunctions(), /*reuse=*/false, SooEnabled());
                        return;
                    }
                    if (fits_in_soo(size()))
                    {
            ...
            template<class K = key_type>
            ABSL_DEPRECATE_AND_INLINE()
            const_iterator find(const key_arg<K>& key, size_t) const ABSL_ATTRIBUTE_LIFETIME_BOUND
            {
                return find(key);
            }
            template<class K = key_type>
        ...
        private:
            ...
            iterator find_soo(const key_arg<K>& key)
            {
                ...
                return empty() || !PolicyTraits::apply(EqualElement<K>{key, eq_ref()}, PolicyTraits::element(soo_slot())) ? end() : soo_iterator();
            }
            ...
            {
                ABSL_SWISSTABLE_ASSERT(is_soo());
                if (!ShouldSampleHashtablezInfo<CharAlloc>())
                    return HashtablezInfoHandle{};
                return Sample(sizeof(slot_type), sizeof(key_type), sizeof(value_type), SooCapacity());
            }

            inline void destroy_slots()
            {
                ABSL_SWISSTABLE_ASSERT(!is_soo());
                if (PolicyTraits::template destroy_is_trivial<Alloc>())
                    return;
                IterateOverFullSlots(
                    common(), slot_array(), [&](const ctrl_t*, slot_type* slot) ABSL_ATTRIBUTE_ALWAYS_INLINE
                    { this->destroy(slot); }
                );
            }
            ...
            inline void dealloc()
            {
                ...
                Deallocate<BackingArrayAlignment(alignof(slot_type))>(
                    &alloc_ref(), common().backing_array_start(), common().alloc_size(sizeof(slot_type), alignof(slot_type))
                );
            }
            ...
            {
                ABSL_SWISSTABLE_ASSERT(!is_soo());
                EraseMetaOnly(common(), static_cast<size_t>(it.control() - control()), sizeof(slot_type));
            }

            size_t hash_of(slot_type* slot) const
            {
                return PolicyTraits::apply(HashElement{hash_ref()}, PolicyTraits::element(slot));
            }
            ...
            ABSL_ATTRIBUTE_NOINLINE static void resize_impl(
                CommonFields& common, size_t new_capacity, HashtablezInfoHandle forced_infoz
            )
            {
                ...
                const ctrl_t soo_slot_h2 =
                    had_soo_slot ? static_cast<ctrl_t>(H2(set->hash_of(set->soo_slot()))) : ctrl_t::kEmpty;
                HashSetResizeHelper resize_helper(common, was_soo, had_soo_slot, forced_infoz);
                ...
                {
                    set->transfer(set->to_slot(resize_helper.old_soo_data()), set->soo_slot());
                }
                ...
                const bool grow_single_group =
                    resize_helper.InitializeSlots<CharAlloc, sizeof(slot_type), PolicyTraits::transfer_uses_memcpy(), SooEnabled(), alignof(slot_type)>(
                        common, CharAlloc(set->alloc_ref()), soo_slot_h2, sizeof(key_type), sizeof(value_type)
                    );
                ...
                if (grow_single_group)
                {
                    ...
                    else
                    {
                        ...
                        resize_helper.GrowSizeIntoSingleGroup<PolicyTraits>(common, set->alloc_ref());
                    }
                }
                else
                {
                    ...
                    {
                        size_t hash = PolicyTraits::apply(HashElement{set->hash_ref()}, PolicyTraits::element(slot));
                ...
                resize_helper.DeallocateOld<alignof(slot_type)>(CharAlloc(set->alloc_ref()), sizeof(slot_type));
            }
            ...
            static void move_common(bool rhs_is_full_soo, allocator_type& rhs_alloc, CommonFields& lhs, CommonFields&& rhs)
            {
                ...
                else
                {
                    ...
                    rhs.RunWithReentrancyGuard([&]
                                               { lhs.RunWithReentrancyGuard([&]
                                                                            { PolicyTraits::transfer(&rhs_alloc, to_slot(lhs.soo_data()), to_slot(rhs.soo_data())); }); });
                }
            }
            ...
            void swap_common(raw_hash_set& that)
            {
                ...
                move_common(that_is_full_soo, that.alloc_ref(), tmp, std::move(that.common()));
            ...
            )
            {
                ...
                if (SwisstableGenerationsEnabled())
                {
                    that.common().set_capacity(this == &that ? InvalidCapacity::kSelfMovedFrom : InvalidCapacity::kMovedFrom);
                }
            ...
            raw_hash_set& assign_impl(raw_hash_set&& that)
            {
                ...
                destructor_impl();
                move_common(that.is_full_soo(), that.alloc_ref(), common(), std::move(that.common()));
                hash_ref() = that.hash_ref();
                eq_ref() = that.eq_ref();
                CopyAlloc(alloc_ref(), that.alloc_ref(), std::integral_constant<bool, propagate_alloc>());
                that.common() = CommonFields::CreateDefault<SooEnabled()>();
                annotate_for_bug_detection_on_move(that);
                return *this;
            }
            ...
            raw_hash_set& move_assign(raw_hash_set&& that, std::true_type /*propagate_alloc*/)
            {
                return assign_impl<true>(std::move(that));
            }
            raw_hash_set& move_assign(raw_hash_set&& that, std::false_type /*propagate_alloc*/)
            {
            ...
            std::pair<iterator, bool> find_or_prepare_insert_soo(const K& key)
            {
                ...
                else if (PolicyTraits::apply(EqualElement<K>{key, eq_ref()}, PolicyTraits::element(soo_slot())))
                {
            ...
            std::pair<iterator, bool> find_or_prepare_insert_non_soo(const K& key)
            {
                ...
                while (true)
                {
                    ...
                    if (ABSL_PREDICT_TRUE(mask_empty))
                    {
                        ...
                        return {iterator_at(PrepareInsertNonSoo(common(), hash, FindInfo{target, seq.index()}, GetPolicyFunctions())), true};
                    }
                    seq.next();
                    ABSL_SWISSTABLE_ASSERT(seq.index() <= capacity() && "full table!");
                }
        ...
        protected:
            ...
            void AssertNotDebugCapacity() const
            {
                ...
                assert(capacity() != InvalidCapacity::kReentrance && "Reentrant container access during element construction/destruction "
                                                                     "is not allowed.");
                assert(capacity() != InvalidCapacity::kDestroyed && "Use of destroyed hash table.");
                if (SwisstableGenerationsEnabled() &&
            ...
            void AssertHashEqConsistent(const K& key)
            {
                ...
                const auto assert_consistent = [&](const ctrl_t*, slot_type* slot)
                {
                    ...
                    assert((!is_key_equal || is_hash_equal) && "eq(k1, k2) must imply that hash(k1) == hash(k2). "
            ...
            void emplace_at(iterator iter, Args&&... args)
            {
                ...
                assert(PolicyTraits::apply(FindElement{*this}, *iter) == iter && "constructed value does not match the lookup key");
            }
        ...
        private:
            ...
            const CommonFields& common() const
            {
                return settings_.template get<0>();
            }
            ...
            static void dealloc_fn(CommonFields& common, const PolicyFunctions&)
            {
                ...
                // Unpoison before returning the memory to the allocator.
                SanitizerUnpoisonMemoryRegion(common.slot_array(), sizeof(slot_type) * common.capacity());

                common.infoz().Unregister();
                Deallocate<BackingArrayAlignment(alignof(slot_type))>(
                    &set->alloc_ref(), common.backing_array_start(), common.alloc_size(sizeof(slot_type), alignof(slot_type))
                );
            }
            ...
            static const PolicyFunctions& GetPolicyFunctions()
            {
                static constexpr PolicyFunctions value = {
                    ...
                    std::is_empty<hasher>::value ? &GetHashRefForEmptyHasher : &raw_hash_set::get_hash_ref_fn,
                    PolicyTraits::template get_hash_slot_fn<hasher>(),
                    PolicyTraits::transfer_uses_memcpy() ? TransferRelocatable<sizeof(slot_type)> : &raw_hash_set::transfer_slot_fn,
                    (std::is_same<SlotAlloc, std::allocator<slot_type>>::value ? &DeallocateStandard<alignof(slot_type)> : &raw_hash_set::dealloc_fn),
            ...
            absl::container_internal::CompressedTuple<CommonFields, hasher, key_equal, allocator_type>
                settings_{CommonFields::CreateDefault<SooEnabled()>(), hasher{}, key_equal{}, allocator_type{}};
        };
        ...
        struct HashtableFreeFunctionsAccess
        {
            ...
            static typename Set::size_type EraseIf(Predicate& pred, Set* c)
            {
                ...
                if (c->is_soo())
                {
                    ...
                    if (!pred(*it))
                    {
                        ABSL_SWISSTABLE_ASSERT(c->size() == 1 && "hash table was modified unexpectedly");
                        return 0;
                    }
                    c->destroy(it.slot());
          ...
          if (pred(Set::PolicyTraits::element(slot))) {
            ...
            ++num_deleted;
                ...
                ABSL_SWISSTABLE_ASSERT(original_size_for_assert - num_deleted == c->size() && "hash table was modified unexpectedly");
                return num_deleted;
            }
