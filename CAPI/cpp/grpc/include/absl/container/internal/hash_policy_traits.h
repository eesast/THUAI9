...
#endif
                return Policy::template get_hash_slot_fn<Hash>() == nullptr ? &hash_slot_fn_non_type_erased<Hash> : Policy::template get_hash_slot_fn<Hash>();
#if defined(__GNUC__) && !defined(__clang__)
#pragma GCC diagnostic pop
            ...
            static constexpr bool soo_enabled()
            {
                return soo_enabled_impl(Rank1{});
            }
        ...
        private:
            ...
            {
                return Policy::apply(HashElement<Hash>{*static_cast<const Hash*>(hash_fn)}, Policy::element(static_cast<slot_type*>(slot)));
            }
            ...
            static constexpr bool soo_enabled_impl(Rank0)
            {
                return true;
            }
        };
