...
namespace absl
{
    ...
    namespace time_internal
    {
        ...
        ABSL_ATTRIBUTE_CONST_FUNCTION constexpr Duration FromInt64(int64_t v, std::ratio<1, N>);
    ...
    private:
        ...
        public:
            ...
            explicit constexpr HiRep(const int64_t value) :  // C++17 forbids default-initialization in constexpr contexts. We can
                                                             // remove this in C++20.
            ...
            constexpr int64_t Get() const
            {
                ...
                static_assert(
                    (static_cast<int64_t>((std::numeric_limits<uint64_t>::max)()) ==
                     int64_t{-1}) &&
                        (static_cast<int64_t>(static_cast<uint64_t>((std::numeric_limits<int64_t>::max)()) + 1) ==
