...
inline int64_t OccupyMsg::_internal_target_compute_center_id() const {
  return target_compute_center_id_;
}
...
inline void OccupyMsg::_internal_set_target_compute_center_id(int64_t value) {
  ...
  target_compute_center_id_ = value;
}
...
inline ::protobuf::TechType UplevelTechMsg::_internal_tech_type() const {
  return static_cast< ::protobuf::TechType >(tech_type_);
}
...
inline ::protobuf::ProductionSuggestion* StrategicAIResponse::mutable_production_plan(int index) {
  ...
  return production_plan_.Mutable(index);
}
...
inline ::protobuf::TaskSuggestion* StrategicAIResponse::mutable_task_plan(int index) {
  ...
  return task_plan_.Mutable(index);
}
...
inline ::protobuf::AIActionType TaskSuggestion::_internal_action_type() const {
  return static_cast< ::protobuf::AIActionType >(action_type_);
}
