...
start "THUAI9 Server" cmd /k "cd /d ""%ROOT%logic\Server"" && dotnet run --no-build -- --port %SERVER_PORT% --teamCount 4 --gameTimeInSecond %GAME_TIME_SECONDS% --fileName %REPLAY_FILE_NAME%"
